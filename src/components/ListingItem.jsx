...
// import 'moment/locale/uz'; // Uzbek tilini import qilish
...
export default function ListingItem({ listing, id, onDelete, onEdit }) {
	// Moment.globalLocale = 'uz'; // Uzbek tilini o'rnatish
	return (
	...
	{/* listening.timestamp null va undifined qiymat bolmasa bizga toDate() funksiyamizmi ishlatib beradi */}
				</Moment>
